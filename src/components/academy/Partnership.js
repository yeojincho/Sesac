  ...
  return (
    <div className='recruit-wrap inner-box'>
      <ul class="cont-navi">
        ...
        <li><span class="nav-sub">제휴제안</span></li>
      </ul>
      <div className="c-top-title">
        <h2>제휴 제안</h2>
        <h3>__엑스퍼트아카데미는 제휴제안을 환영 합니다</h3>
      </div>
      ...
      <div className="recruit-box">
        ...
        <div className="cont-form-box"> 
          <ul className="form-list">
            <li>
              <p className="form-title"><span className="ess">회사(기관)명</span></p>
              <div className="form-cont">
                <div className="count-input inp">
                  <input type="text" className="ipt-txt"  placeholder="회사(기관)명을 입력해주세요." />
                </div>
              </div>
            </li>
            <li>
              <p className="form-title"><span className="ess">제안자명</span></p>
              <div className="form-cont">
                <div className="count-input inp">
                  <input type="text" className="ipt-txt"  placeholder="제안자명을 입력해주세요." />
                </div>
              </div>
            </li>
            <li>
              ...
              <div className="form-cont">
                <div className="count-input inp">
                  <input type="text" className="ipt-txt"  placeholder="연락처 입력해주세요." />
                </div>
              </div>
            </li>
            <li>
              ...
              <div className="form-cont">
                <div className="count-input inp">
                  <input type="text" className="ipt-txt"  placeholder="이메일 입력해주세요." />
                </div>
              </div>
            </li>
            <li>
              <p className="form-title"><span>제안 내용</span></p>
              <div className="form-cont">
                <div className="count-input ta">
                  <textarea id="title1" title="내용" placeholder="제안 내용을 입력해주세요." ></textarea>
                </div>
              </div>
            </li>
            <li>
              <p className="form-title"><span>제안서 첨부</span></p>
              <div className="form-cont">
          ...
          <div className="c-btn-box">
            <button className="btn-type2"><span>제안서 보내기</span></button>
          </div>
          </Link>
        </div>
      </div>
