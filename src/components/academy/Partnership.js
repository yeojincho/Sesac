...
function Partnership() {
  return (
    <div className="inner-box wrap">
      ...
      <span>엑스퍼트 아카데미는 제휴제안을 환영합니다.</span>
      <div>
        <img className="companyImg" src={"/images/company.png"} />
      </div>
      <Form>
        <FormGroup>
          <Label className="topTitle" for="title">
            제목
          </Label>
          <Input
            id="titleId"
        ...
        <FormGroup>
          <Label for="examplePassword">제안자명</Label>
          <Input
            id="proposalId"
            name="proposalName"
        ...
        <FormGroup>
          <Label for="examplePassword">연락처</Label>
          <Input
            id="phoneId"
            name="phoneName"
        ...
        <FormGroup>
          <Label for="exampleText">제안내용</Label>
          <Input id="exampleText" name="text" type="textarea" />
        </FormGroup>
        <FormGroup>
          <Label for="exampleFile">제안서첨부</Label>
