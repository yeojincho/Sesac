  ...
  return (
    ...
    <header className="header-wrapper2">
      <div className="inner-box header-inner">
        ...
        <ul className="gnb" onMouseOver={()=>setIsGnbOpen(true)} onMouseLeave={()=>setIsGnbOpen(false)} >
          <li className="depth1">
            <Link to="/" onClick={subMenuCloseFn}>공개과정</Link>
            <ul className="depth2" >
              <li>
          ...
          <li className="depth1">
            <Link to="/job" onClick={subMenuCloseFn}>취업과정</Link>
            <ul class="depth2">
              <li>
          ...
          <li className="depth1">
            <Link to="/notice" onClick={subMenuCloseFn}>고객센터</Link>
            <ul className="depth2">
              <li>
          ...
          <li className="depth1">
            <Link to="/" onClick={subMenuCloseFn}>아카데미</Link>
            <ul className="depth2">
              <li>
